...
public class EmployeeConstants {
    ...
    public static final Employee EMPLOYEE_3 = new Employee(3, "name3", 30000, new Position(2, "java"));
    ...
    public static final EmployeeDTO EMPLOYEE_DTO_3 = new EmployeeDTO(3, "name3", 30000, new Position(2, "java"));
    ...
    public static final EmployeeFullInfo EMPLOYEE_FULL_INFO_3 = new EmployeeFullInfo("name3", 30000, "java");
